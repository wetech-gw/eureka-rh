...
class FuncionarioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        DB::table('funcionarios')->insert([
            ...
            'data_fim_periodo_experiencia' => $request->data_fim_periodo_experiencia,
        ...
        return redirect()->route('funcionarios.index')->with('success', 'Funcionário registado com sucesso!');
    }
