...
class PresencaController extends Controller
{
    ...
    public function index()
    {
        ...
        $taxaAssiduidade = $totalRegistosMes > 0 
        ...
        $presencas = DB::table('presencas')
            ->join('funcionarios', 'presencas.funcionario_id', '=', 'funcionarios.id')
            ->select(
                'presencas.*',
    ...
    public function store(Request $request)
    {
        ...
        // 2. Gravar na tabela "presencas" fazendo o mapeamento correto das colunas
        ...
        return redirect()->route('presencas.index')->with('success', 'Presença registada com sucesso!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('presencas.index')->with('success', 'Registo de presença atualizado com sucesso!');
    }
}