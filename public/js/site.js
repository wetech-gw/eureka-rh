...
"use strict";
  ...
  const I18N = {
    pt: {
      ...
      "sec.treino.eyebrow":"Capacitação & Desenvolvimento","sec.treino.title":"O Nosso Treino","sec.treino.desc":"Programas de formação contínua desenhados para elevar competências pessoais e profissionais na sua organização.",
      "sec.treino.n1":"Liderança & Gestão","sec.treino.n2":"Contabilidade & Finanças, Controlo de Gestão e Controlo Interno","sec.treino.n3":"Autoconfiança e Desenvolvimento Pessoal","sec.treino.n4":"Produtividade no Local de Trabalho","sec.treino.n5":"Gestão de Recursos Humanos","sec.treino.n6":"Marketing & Comunicação","sec.treino.n7":"Gestão de Projetos, Monitorização e Avaliação",
      "sec.tb.eyebrow":"Dinâmicas de Grupo","sec.tb.title":"Team Building","sec.tb.desc":"Atividades focadas no fortalecimento de relações, coesão de equipa e resolução colaborativa de problemas.",
      "sec.tb.c1":"Construção da Equipa e Coesão da Equipa","sec.tb.c2":"Quebra-Gelo em Equipa","sec.tb.c3":"Resolução de Problemas","sec.tb.c4":"Coesão da Equipa (Interior, Online, Exterior)",
      "sec.ev.eyebrow":"Iniciativa de Impacto","sec.ev.title":"O Nosso Evento Principal","sec.ev.subtitle":"Guinée Bissau Talents",
      "sec.ev.p1":"Estabelecimento dos dias anuais de talento e oportunidade com parceiros estratégicos","sec.ev.p2":"Fórum de Emprego: Ponto de encontro entre potenciais empregadores e os melhores candidatos em formação de competências e conhecimentos ambientais da Guiné-Bissau","sec.ev.p3":"Reunião entre líderes de projeto e detentores de capitais, como bancos e outros investidores potencial","sec.ev.p4":"Bancas de informação de pequenas e médias empresas e outras organizações nacionais e internacionais","sec.ev.p5":"Debates e mesas-redondas sobre temas relacionados com o desenvolvimento da Guiné-Bissau, orientações económicas, formação de jovens e sua integração profissional, criação e gestão de empresas, procura de financiamento junto dos bancos e papel dos operadores económicos","sec.ev.p6":"Reconhecimentos e prémios para estudantes, inventores, empreendedores e líderes empresariais",
      ...
      "cand.carta":"Carta de Motivação (PDF ou DOCX)","cand.cartaHint":"Opcional · Tamanho máximo: 2MB",
    ...
    fr: {
      ...
      "sec.treino.eyebrow":"Formation & Développement","sec.treino.title":"Notre Formation","sec.treino.desc":"Programmes de formation continue conçus pour élever les compétences personnelles et professionnelles au sein de votre organisation.",
      "sec.treino.n1":"Leadership & Management","sec.treino.n2":"Comptabilité & Finance, Contrôle de Gestion et Contrôle Interne","sec.treino.n3":"Confiance en soi et Développement Personnel","sec.treino.n4":"Productivité sur le Lieu de Travail","sec.treino.n5":"Gestion des Ressources Humaines","sec.treino.n6":"Marketing & Communication","sec.treino.n7":"Gestion de Projets, Suivi et Évaluation",
      "sec.tb.eyebrow":"Dynamiques de Groupe","sec.tb.title":"Team Building","sec.tb.desc":"Activités axées sur le renforcement des relations, la cohésion d'équipe et la résolution collaborative de problèmes.",
      "sec.tb.c1":"Construction et Cohésion d'Équipe","sec.tb.c2":"Brise-Glace en Équipe","sec.tb.c3":"Résolution de Problèmes","sec.tb.c4":"Cohésion d'Équipe (Intérieur, En ligne, Extérieur)",
      "sec.ev.eyebrow":"Initiative à Impact","sec.ev.title":"Notre Événement Principal","sec.ev.subtitle":"Guinée Bissau Talents",
      "sec.ev.p1":"Établissement des journées annuelles de talent et d'opportunité avec des partenaires stratégiques","sec.ev.p2":"Forum d'Emploi : Point de rencontre entre employeurs potentiels et les meilleurs candidats en formation de compétences et connaissances environnementales de Guinée-Bissau","sec.ev.p3":"Réunion entre leaders de projet et détenteurs de capitaux, comme les banques et autres investisseurs potentiels","sec.ev.p4":"Stands d'information de petites et moyennes entreprises et autres organisations nationales et internationales","sec.ev.p5":"Débats et tables rondes sur des thèmes liés au développement de la Guinée-Bissau, orientations économiques, formation des jeunes et leur intégration professionnelle, création et gestion d'entreprises, recherche de financement auprès des banques et rôle des opérateurs économiques","sec.ev.p6":"Reconnaissances et prix pour étudiants, inventeurs, entrepreneurs et leaders d'entreprise",
      ...
      "cand.carta":"Lettre de motivation (PDF ou DOCX)","cand.cartaHint":"Facultatif · Taille maximale : 2 Mo",
    ...
    en: {
      ...
      "sec.treino.eyebrow":"Capacity Building & Development","sec.treino.title":"Our Training","sec.treino.desc":"Continuous training programmes designed to elevate personal and professional skills within your organisation.",
      "sec.treino.n1":"Leadership & Management","sec.treino.n2":"Accounting & Finance, Management Control and Internal Control","sec.treino.n3":"Self-Confidence and Personal Development","sec.treino.n4":"Workplace Productivity","sec.treino.n5":"Human Resources Management","sec.treino.n6":"Marketing & Communication","sec.treino.n7":"Project Management, Monitoring and Evaluation",
      "sec.tb.eyebrow":"Group Dynamics","sec.tb.title":"Team Building","sec.tb.desc":"Activities focused on strengthening relationships, team cohesion and collaborative problem-solving.",
      "sec.tb.c1":"Team Building & Cohesion","sec.tb.c2":"Team Icebreaker","sec.tb.c3":"Problem Solving","sec.tb.c4":"Team Cohesion (Indoor, Online, Outdoor)",
      "sec.ev.eyebrow":"Impact Initiative","sec.ev.title":"Our Main Event","sec.ev.subtitle":"Guinée Bissau Talents",
      "sec.ev.p1":"Establishment of annual talent and opportunity days with strategic partners","sec.ev.p2":"Job Forum: Meeting point between potential employers and top candidates in skills training and environmental knowledge of Guinea-Bissau","sec.ev.p3":"Meeting between project leaders and capital holders, such as banks and other potential investors","sec.ev.p4":"Information stands of small and medium-sized enterprises and other national and international organisations","sec.ev.p5":"Debates and round tables on themes related to the development of Guinea-Bissau, economic guidance, youth training and their professional integration, business creation and management, seeking financing from banks and the role of economic operators","sec.ev.p6":"Recognition and awards for students, inventors, entrepreneurs and business leaders",
      ...
      "cand.carta":"Cover Letter (PDF or DOCX)","cand.cartaHint":"Optional · Maximum size: 2MB",
