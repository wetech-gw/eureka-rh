    ...
    <main class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">Controlo de fluxos, termos, guias de entrega e saídas oficiais</p>
            </div>
                        ...
                        @forelse($documentos as $doc)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($doc->arquivo_pdf)
                                        <a href="{{ asset('storage/' . $doc->arquivo_pdf) }}" target="_blank" class="btn btn-sm btn-light border text-dark fw-medium">
