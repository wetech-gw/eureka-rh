...
<head>
    ...
    <style>
        ...
        .sidebar { width: 240px; height: 100vh; background: white; flex-shrink: 0; position: sticky; top: 0; z-index: 100; overflow: hidden; scrollbar-width: thin; scrollbar-color: #d4d4d4 transparent; }
