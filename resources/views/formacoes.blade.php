                    ...
                    <tbody>
                        @forelse($formacoes as $f)
                            <tr class="formacao-row">
                                ...
                                <td>{{ \Carbon\Carbon::parse($f->data_inicio)->format('d/m/Y') }} @if($f->hora_inicio)<span class="text-muted small d-block">{{ \Carbon\Carbon::parse($f->hora_inicio)->format('H:i') }}</span>@endif</td>
                                <td>{{ \Carbon\Carbon::parse($f->data_fim)->format('d/m/Y') }} @if($f->hora_fim)<span class="text-muted small d-block">{{ \Carbon\Carbon::parse($f->hora_fim)->format('H:i') }}</span>@endif</td>
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 14px;">
            ...
            <form action="{{ route('formacoes.store') }}" method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-6">
                            <label for="hora_inicio" class="form-label small fw-bold text-muted text-uppercase">Hora de Início</label>
                            <input type="time" class="form-control form-control-sm rounded-3" id="hora_inicio" name="hora_inicio" required>
                        </div>
                        <div class="col-6">
                            <label for="hora_fim" class="form-label small fw-bold text-muted text-uppercase">Hora de Fim</label>
                            <input type="time" class="form-control form-control-sm rounded-3" id="hora_fim" name="hora_fim" required>
                        </div>
                    </div>
